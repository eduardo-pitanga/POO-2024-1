...
public class Entrada {
    ...
    public void menu2(Sistema s, Usuario u) throws IOException {
        String msg = "*********************\n" +
                "Escolha uma opção:\n" +
                "1) Seguir alguém.\n" +
        ...
        while (op!=0) {
            if (op == 1) {
                ...
                while (u2 == null) {
                    ...
                    u2 = s.buscarUsuario(this.lerLinha("Usuario: "));
                }
                u.seguir(u2, s);
                s.SalvarDados();
            }
     ...
     */
    public void cadPessoa(Sistema s) throws IOException {
     ...
     * @param s: Um objeto da classe Sistema
     */
    public void cadEmpresa(Sistema s) throws IOException {
        String login = this.lerLinha("Escolha um login: ");
    ...
    public void login(Sistema s) throws IOException {
        ...
        while (user == null) {
            login = this.lerLinha("Usuario não encontrado, tente novamente: ");
            user = s.buscarUsuario(login);
        }
        String senha = this.lerLinha("Digite sua senha: ");

        if (user.validarAcesso(senha)) {
            this.menu2(s, user);
        } else System.out.println("Senha incorreta, voltando para o menu inicial.");
    }
